...
# sns.lineplot(data=data, x=data.index, y='Interest', color='blue', marker='o', label='Интерес по времени')
...
# # Если данных слишком короткие, декомпозиция может не сработать
# if len(data) >= 52:
